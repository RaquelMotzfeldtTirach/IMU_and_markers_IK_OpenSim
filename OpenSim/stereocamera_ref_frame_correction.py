...
# For the stereocamera data it is a bit more complicated
...
def main(subject_ID, mvt_ID):
    ...
    stereocamera_file_path = "recordings/subject" + subject_ID + "/stereocamera_" + mvt_ID + ".trc"
    stereocamera_df = read_trc_file(stereocamera_file_path)
    # Inspect stereocamera df
    ...
    write_trc_file(translated_rotated_stereocamera_df, stereocamera_file_path, stereocamera_file_path)
