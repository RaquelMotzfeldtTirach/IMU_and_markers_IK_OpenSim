...
def create_config_file(config_template_path, subject_ID, subject_mass, subject_height, subject_sex, subject_age, static_trial_path, output_model_file, output_model_file_1, mvt_ID, model_path, initial_time):
...
def main(subject_ID, mvt_ID, subject_mass, subject_height, subject_age, subject_sex, model_path):
    ...
    output_model_file_1 = "../../OpenSim/Models/Rajagopal/Calibrated_Rajagopal_subject" + subject_ID + "_" + mvt_ID + "_markerPlacer.osim"
    ...
    config_path = create_config_file(config_template_path, subject_ID, subject_mass, subject_height, subject_sex, subject_age, static_trial_path, output_model_file, output_model_file_1, mvt_ID, model_path, initial_time)
